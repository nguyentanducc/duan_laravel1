      ...
      <div class="card rounded-0 border-0 shadow-sm mb-4">
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control rounded-0" id="name" name="name" value="{{$Sp->name}}" readonly>
          </div>
          <div class="mb-3">
            <label for="description" class="form-label">Description</label>
            <textarea class="form-control rounded-0" id="description" name="description" rows="6" value="{{$Sp->description}}" readonly></textarea>
          </div>
          <div class="row">
            <div class="col mb-3">
              <label for="instock" class="form-label">Instock *</label>
              <input type="number" class="form-control rounded-0" id="instock" min="0" name="instock"  value="{{$Sp->instock}}" readonly>
            </div>
            <div class="col mb-3">
              <label for="category" class="form-label">Category *</label>
              <div class="input-group">
                <select class="form-select rounded-0" id="category" name="category_id" @readonly(true)>

                  @foreach ($dsDm as $dm)
                  <option value="{{$dm->id}}" readonly>{{$dm->name}}</option>     
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col mb-3">
              ...
              <input type="number" class="form-control rounded-0" id="price" min="0" name="price" value="{{($Sp->price)}}" readonly>
            </div>
            <div class="col mb-3">
              <label for="sale_price" class="form-label">Sale Price</label>
              <input type="number" class="form-control rounded-0" id="sale_price" min="0" name="sale_price" value="{{($Sp->sale_price)}}" readonly>
            </div>
          </div>
        </div>
      </div>
