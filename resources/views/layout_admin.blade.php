...
<head>
  ...
  <title>@yield('title')|Admin Board of Duke</title>
  ...
  <div class="d-flex min-vh-100">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-primary" style="max-width: 280px;" data-bs-theme="dark">
      ...
      <ul class="nav nav-pills flex-column mb-auto" data-bs-themes>
        <li class="nav-item">
          <a href="{{route('admin.dashboard')}}" class="nav-link rounded-0 {{(Request::routeIs('admin.dashboard'))?'active':'text-while'}}" aria-current="page">
            <i class="far fa-tachometer-alt-fastest fa-fw"></i>
            <span class="d-none d-sm-inline-block">Dashboard</span>
          </a>
        </li>
        <li>
          <a href="{{route('admin.order')}}" class="nav-link rounded-0 {{(Request::routeIs('admin.order'))?'active':'text-while'}}">
            <i class="far fa-shopping-cart fa-fw"></i>
            <span class="d-none d-sm-inline-block">Orders</span>
          </a>
        </li>
        <li>
          <a href="{{route('admin.product')}}" class="nav-link rounded-0 {{(Request::routeIs('admin.product'))?'active':'text-while'}}">
            <i class="far fa-boxes fa-fw"></i>
            <span class="d-none d-sm-inline-block">Products</span>
          </a>
        </li>
        <li>
          <a href="{{route('admin.user')}}" class="nav-link rounded-0 {{(Request::routeIs('admin.user'))?'active':'text-while'}}">
